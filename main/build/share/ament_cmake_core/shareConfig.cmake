...
if(_share_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED share_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(share_FOUND FALSE)
  elseif(NOT share_FOUND)
    # use separate condition to avoid uninitialized variable warning
    set(share_FOUND FALSE)
  endif()
  return()
endif()
set(_share_CONFIG_INCLUDED TRUE)

# output package information
if(NOT share_FIND_QUIETLY)
  message(STATUS "Found share: 0.0.0 (${share_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'share' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${share_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(share_FOUND_AMENT_PACKAGE TRUE)
