...
static const _SendCAN0_type_support_symbol_names_t _SendCAN0_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, share, msg, SendCAN0)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, share, msg, SendCAN0)),
  }
};
...
{
  return &::share::msg::rosidl_typesupport_cpp::SendCAN0_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, share, msg, SendCAN0)() {
  return get_message_type_support_handle<share::msg::SendCAN0>();
}
